...
from .transformer import PythonSourceGeneratorTransformer, input_filenames_argument_name, tree_name_argument_name
...
def generate_python_source(ast, function_name='run_query'):
    ...
    source = 'def ' + function_name + '(' + input_filenames_argument_name + '=None, ' + tree_name_argument_name + '=None):\n'
